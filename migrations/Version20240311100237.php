 ...
 */
final class Version20240311100237 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE job_offer ADD category_id INT NOT NULL, DROP category');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE job_offer ADD category VARCHAR(255) NOT NULL, DROP category_id');
    }
}
